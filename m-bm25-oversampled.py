...
def main():
    ...
    file = open('ttpdrill_bias_corrected_final_result.txt', 'w')
    ...
    for top_n_class in [2, 4, 8, 16, 32, 64]:
        ...
        X_train_res, y_train_res = sm.fit_resample(trainAndTestSetFiltered.iloc[:, 5:numOfColumns], trainAndTestSetFiltered['name'].ravel())
        ...
        for item in ['knn', 'nb', 'svm', 'rf', 'dt', 'nn']:
            ...
            for index in range(0, 5):
                ...
                # print(classification_report(test[index]['name'], predicted))
